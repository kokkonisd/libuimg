...
char * test_flipX_for_YUV444 ()
{
    ...
    res = flipX_image(img_yuv444);
    CUTS_ASSERT(res == 1, "Could not flip YUV444 image along the X axis");
...
char * test_flipX_for_YUV444p ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_yuv444p);
    CUTS_ASSERT(res == 1, "Could not flip YUV444p image along the X axis");
...
char * test_flipX_for_YUV420p ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_yuv420p);
    CUTS_ASSERT(res == 1, "Could not flip YUV420p image along the X axis");
...
char * test_flipX_for_RGB24 ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_rgb24);
    CUTS_ASSERT(res == 1, "Could not flip RGB24 image along the X axis");
...
char * test_flipX_for_RGB565 ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_rgb565);
    CUTS_ASSERT(res == 1, "Could not flip RGB565 image along the X axis");
...
char * test_flipX_for_RGB8 ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_rgb8);
    CUTS_ASSERT(res == 1, "Could not flip RGB8 image along the X axis");
...
char * test_flipX_for_GRAYSCALE ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_grayscale);
    CUTS_ASSERT(res == 1, "Could not flip GRAYSCALE image along the X axis");
...
char * test_flipX_for_ASCII ()
{
    ...
    // Flip image along the X axis
    res = flipX_image(img_ascii);
    CUTS_ASSERT(res == 1, "Could not flip ASCII image along the X axis");
...
char * all_tests ()
{
    ...
    CUTS_RUN_TEST(test_flipX_for_YUV444);
    CUTS_RUN_TEST(test_flipX_for_YUV444p);
    CUTS_RUN_TEST(test_flipX_for_YUV420p);
    CUTS_RUN_TEST(test_flipX_for_RGB24);
    CUTS_RUN_TEST(test_flipX_for_RGB565);
    CUTS_RUN_TEST(test_flipX_for_RGB8);
    CUTS_RUN_TEST(test_flipX_for_GRAYSCALE);
    CUTS_RUN_TEST(test_flipX_for_ASCII);
